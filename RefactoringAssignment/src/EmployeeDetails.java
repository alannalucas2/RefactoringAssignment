...
public class EmployeeDetails extends JFrame implements ActionListener, ItemListener, DocumentListener, WindowListener {
	...
	private JPanel searchPanel() {
		...
		searchPanel.add(searchId = new JButton(new ImageIcon(
				new ImageIcon("icons/search.png").getImage().getScaledInstance(35, 20, java.awt.Image.SCALE_SMOOTH))),
		...
		searchPanel.add(
				searchSurname = new JButton(new ImageIcon(new ImageIcon("icons/search.png").getImage()
	...
	private JPanel navigPanel() {
		...
		navigPanel.add(first = new JButton(new ImageIcon(
				new ImageIcon("icons/first.png").getImage().getScaledInstance(17, 17, java.awt.Image.SCALE_SMOOTH))));
		first.setPreferredSize(new Dimension(17, 17));
		first.addActionListener(this);
		first.setToolTipText("Display first Record");

		navigPanel.add(previous = new JButton(new ImageIcon(new ImageIcon("icons/prev.png").getImage()
		...
		navigPanel.add(next = new JButton(new ImageIcon(
				new ImageIcon("icons/next.png").getImage().getScaledInstance(17, 17, java.awt.Image.SCALE_SMOOTH))));
		...
		navigPanel.add(last = new JButton(new ImageIcon(
				new ImageIcon("icons/last.png").getImage().getScaledInstance(17, 17, java.awt.Image.SCALE_SMOOTH))));
